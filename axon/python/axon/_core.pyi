...
class Tensor:
    ...
    def argmax(self, dim: int, keepdims: bool = False) -> Tensor: ...
    ...
    @staticmethod
    def ones_like(like: Tensor, requires_grad: bool = False, dtype: dtype = dtype.float32) -> Tensor: ...

    @staticmethod
    def zeros_like(like: Tensor, requires_grad: bool = False, dtype: dtype = dtype.float32) -> Tensor: ...
