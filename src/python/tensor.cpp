...
export module axon.bindings.tensor;
...
//
//   auto requires_grad() const -> bool { return
//   graph_->requires_grad(inst_id_); } auto inst_id() const -> InstId { return
//   inst_id_; } auto data() const -> Data {
